...
public static class RuinaAudio
{
    // Using my own audio implementation for now since BaseLib doesn't offer things like music support
    ...
    public static void Play(string path, float volume = 0f, float pitchVariation = 0f, float basePitch = 1f)
    {
    ...
    public static void Play(Creature creature, string path, float volume = 0f)
    {
        Play(path, volume);
    }
    ...
    public static void StopMusic()
    {
        ...
        public static bool IsPlayingRuinaMusic() => _musicPlayer?.Playing == true;
        
    public static void PlayAmbience(string path, float volumeDbOffset = 0f)
    {
    ...
    public static void FadeInAmbience(string path, float duration = 1.0f, float volumeDbOffset = 0f)
    {
        if (_currentAmbiencePath == path && _ambiencePlayer?.Playing == true)
            return;
