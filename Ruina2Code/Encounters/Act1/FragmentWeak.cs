...
public sealed class FragmentWeak : CustomEncounterModel
{
    public FragmentWeak() : base(RoomType.Monster)
    {
    }
    public override CustomBackgroundAssets? CustomEncounterBackground(ActModel parentAct, Rng rng)
    {
        return new CustomBackgroundAssets("res://BaseLib/scenes/dynamic_background.tscn",
            ["fragment_bg.tscn".BackgroundImagePath()], 
            "fragment_bg.tscn".BackgroundImagePath());
    }
    ...
    public override IEnumerable<MonsterModel> AllPossibleMonsters
    {
        get
        {
            yield return ModelDb.Monster<Fragment>();
        }
    }
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
    {
        ...
        {
            (ModelDb.Monster<Fragment>().ToMutable(), null)
        };
    }
}