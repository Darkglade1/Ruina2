...
public sealed class FuneralNormal : CustomEncounterModel
{
    public FuneralNormal() : base(RoomType.Monster)
    {
    }
    ...
    public override IEnumerable<MonsterModel> AllPossibleMonsters
    {
        get
        {
            yield return ModelDb.Monster<Funeral>();
        }
    }
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
    {
        ...
        {
            (ModelDb.Monster<Funeral>().ToMutable(), null),
        };
    }
}