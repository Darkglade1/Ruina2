...
public sealed class SilentGirlBoss : CustomEncounterModel
{
    public SilentGirlBoss() : base(RoomType.Boss)
    {
    }
    public override string BossNodePath => "SilentGirl/SilentGirlMap".MonsterImagePath().SimplifyPath();
    public override string? CustomRunHistoryIconPath => "SilentGirl/SilentGirlIcon.png".MonsterImagePath().SimplifyPath();
    public override string? CustomRunHistoryIconOutlinePath => "SilentGirl/SilentGirlIconOutline.png".MonsterImagePath().SimplifyPath();
