...
public sealed class PunishingBirdNormal : CustomEncounterModel
{
    public PunishingBirdNormal() : base(RoomType.Monster)
    {
    }
    ...
    public override IEnumerable<MonsterModel> AllPossibleMonsters
    {
        get
        {
            yield return ModelDb.Monster<Keeper>();
            yield return ModelDb.Monster<PunishingBird>();
        }
    }
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
    {
        ...
        {
            (ModelDb.Monster<Keeper>().ToMutable(), null),
            (ModelDb.Monster<Keeper>().ToMutable(), null),
            (ModelDb.Monster<PunishingBird>().ToMutable(), null)
        };
    }
}